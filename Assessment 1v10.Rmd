...
- The main problems I got is that heatmaps have to be rescaled, otherwise they do not show what you think. So, I should consider if I have to change the research questions.
...
In Figure 2 we plot the same graph per type of crime. Except the deceptive practice crime, which at present keeps in similar values as in 2001, the rest of type have been falling to a greater or lesser extent. 
...
Finally, Figure 5 depicts the districts which are more potentially dangerous per tyep of crime. District 11 for instance seems clearly problematic for Narcotics.
