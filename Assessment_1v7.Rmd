...
The dataset analysed is a sample of the [original data of crimes extracted from the Chicago Police Department](https://data.cityofchicago.org/Public-Safety/Crimes-2001-to-present/ijzp-q8t2) that occurred in the city of Chicago from 2001 to present.
...
The number of crimes in Chicago has decrease dramatically per year from 2001 to present.
...
```{r fig11, fig.cap="Type of crime vs location", echo=FALSE, fig.pos="H"}
# add variable: performance
