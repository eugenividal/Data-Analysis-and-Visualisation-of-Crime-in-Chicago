...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dd_aggr <-}\StringTok{ }\KeywordTok{aggregate}\NormalTok{(Count ~}\StringTok{ }\NormalTok{Date, }\DataTypeTok{data =} \NormalTok{dd, }\DataTypeTok{FUN =} \NormalTok{sum)}
\CommentTok{# add cumulative column to the data frame}
\NormalTok{dd_aggr[,}\StringTok{"cum_Count"}\NormalTok{] <-}\StringTok{ }\KeywordTok{cumsum}\NormalTok{(dd_aggr$Count)}
\CommentTok{# cumulative sum over rolling date range}
\end{Highlighting}
\end{Shaded}
